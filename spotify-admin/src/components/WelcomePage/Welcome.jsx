...
const Welcome = ({onShowAuth}) => {
  ...
  const getUsername = (email) => {
    return email ? email.split('@')[0] : 'dhanushkumar';
  };
  ...
  return (
    <div
      ...
      <h1
        className='text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600 flex items-center justify-center text-center'
      ...
      <button
        ...
        className='mt-20 inline-flex items-center px-6 py-3 bg-green-600 text-white text-lg font-semibold rounded-lg hover:bg-green-500 transition-transform transform hover:scale-105 hover:animate-zoom  justify-center'>
